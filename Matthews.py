...
class plan_of_care:
    ...
    def template_1(self):
        ...
        9) It is Mandatory to add these below lines in the end of plan of care in every response:
        ...
        10) It is Mandatory to conclude the plan of care with this line "Follow-up appointment as scheduled."
