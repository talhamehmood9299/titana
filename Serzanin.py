...
class histroy_of_illness:
    ...
    def combine_the_text(self, basic_data, history, template):
        ...
        system_2 = f"""
        You are a medical assistant and your job is to write a history of illness of the patient.
        ...
        Second line always contain this sentence ``I introduced myself as her Healthcare Provider and the Medical Assistant will be doing Medical Documentation accompanying me.``.
        Third line contains the medications which patient is currently using if available.
        Fourth line contains the patient current complains with prescribe medications if available.
        Write the follow up information of disease or disorder in a line separately with only related medications.
        If any medications are mentioned then It is necessary to concluded with "**She reports taking the following CNS medications** and then write the medications in separate lines".
    ...
    """
        prompt_2 = f"""
                ...
                {{{template}}}
                If any medications are mentioned then It is necessary to concluded with "**She reports taking the following CNS medications** and then write medications in separate lines".".
                """
        few_shot_1 = """Michael Saavedra , 44 M pt hx of Anxiety and ADHD, taking Adderall 20mg BID, focused and doing well, denied SI/HI, panic attacks, loss of appetite or sleeping issues."""
        result_1 = """\
        Michael Saavedra is a 44-year-old male patient who has a history of Anxiety and ADHD. I introduced myself as her Healthcare Provider and the Medical Assistant will be doing Medical Documentation accompanying me.\n \
        She has been taking Adderall 20mg BID for ADHD management with enough control\n \
        She stays focused and doing well regarding her daily activities.\n \
        She denied SI/HI, panic attacks, loss of appetite, or sleeping issues.\n \
        **She reports taking the following CNS medications**\n \
        Adderall 20mg BID\n \
        """

        few_shot_2 = """Write a history of illness of the patient based on the text that I will provide"""
        result_2 = """\
               John Tkacs is a 62-year-old male patient who has a history of Anxiety. I introduced myself as his Healthcare Provider and the Medical Assistant will be doing Medical Documentation accompanying me.\n \
               He was prescribed Alprazolam 0.5mg TID and Zoloft 50mg HS for anxiety management which he used with slight control\n \
               He ran out of Alprazolam before the due date as he has been taking it more than the prescribed dose. He reported that he felt better with Zoloft 25mg and wants to be on it back.\n \
               He Denied SI/HI, panic attacks, or AVH. No report of difficulty sleeping or loss of appetite.\n \
               **She reports taking the following CNS medications**\n \
